...
$t_course_students_add = NULL; // Initialize page object first

class ct_course_students_add extends ct_course_students {
	...
	// Page object name
	var $PageObjName = 't_course_students_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_course_studentslist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($t_course_students_add)) $t_course_students_add = new ct_course_students_add();

// Page init
$t_course_students_add->Page_Init();

// Page main
$t_course_students_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_course_students_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var t_course_students_add = new ew_Page("t_course_students_add");
t_course_students_add.PageID = "add"; // Page ID
var EW_PAGE_ID = t_course_students_add.PageID; // For backward compatibility

// Form object
var ft_course_studentsadd = new ew_Form("ft_course_studentsadd");

// Validate form
ft_course_studentsadd.Validate = function() {
...
ft_course_studentsadd.Form_CustomValidate = 
...
ft_course_studentsadd.ValidateRequired = true;
<?php } else { ?>
ft_course_studentsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_course_studentsadd.Lists["x_CourseID"] = {"LinkField":"x_CourseID","Ajax":true,"AutoFill":false,"DisplayFields":["x_CourseCode","x_Course","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_course_studentsadd.Lists["x_StudentID"] = {"LinkField":"x__UserID","Ajax":true,"AutoFill":false,"DisplayFields":["x_RegistrationNumber","x_LastName","x_FirstName",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $t_course_students_add->ShowPageHeader(); ?>
<?php
$t_course_students_add->ShowMessage();
?>
<form name="ft_course_studentsadd" id="ft_course_studentsadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="t_course_students">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_t_course_studentsadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_StudentID", ft_course_studentsadd, true, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
ft_course_studentsadd.AutoSuggests["x_StudentID"] = oas;
</script>
...
<script type="text/javascript">
ft_course_studentsadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$t_course_students_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_course_students_add->Page_Terminate();
?>
