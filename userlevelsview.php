...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($userlevels_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $userlevels_view->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($userlevels_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($userlevels_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $userlevels_view->PageUrl() ?>start=<?php echo $userlevels_view->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $userlevels_view->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
