...
define("EW_PROJECT_NAME", "onlineexam", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{FDF9D461-C8C4-4B01-893C-EAF280CCB667}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Y3vEV4ziERipI11i', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/onlineexam.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_PASS", 'connectit1', TRUE);
define("EW_CONN_DB", 'db_msc_online_exams', TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "surangi", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "Sura83!", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`t_users`",  TRUE);
...
// File upload
define("EW_UPLOAD_DEST_PATH", "/photos/", TRUE); // Upload destination path (relative to app root)
