...
$t_users_add = NULL; // Initialize page object first

class ct_users_add extends ct_users {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_userslist.php"); // No matching record, return to list
				}
				break;
	...
	function RenderRow() {
		...
		if ($this->RowType == EW_ROWTYPE_VIEW) { // View row
			...
			if (($this->CurrentAction == "I" || $this->CurrentAction == "C") && !$this->EventCancelled) ew_RenderUploadField($this->PhotoPath);
...
// Create page object
if (!isset($t_users_add)) $t_users_add = new ct_users_add();

// Page init
$t_users_add->Page_Init();

// Page main
$t_users_add->Page_Main();
...
// Page object
var t_users_add = new ew_Page("t_users_add");
t_users_add.PageID = "add"; // Page ID
var EW_PAGE_ID = t_users_add.PageID; // For backward compatibility

// Form object
var ft_usersadd = new ew_Form("ft_usersadd");
...
ft_usersadd.Form_CustomValidate = 
...
ft_usersadd.ValidateRequired = true;
<?php } else { ?>
ft_usersadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_usersadd.Lists["x_UserLevel"] = {"LinkField":"x_userlevelid","Ajax":null,"AutoFill":false,"DisplayFields":["x_userlevelname","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_usersadd.Lists["x_DesignationID"] = {"LinkField":"x_DesignationID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Designation","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_usersadd.Lists["x_MaritalStatusID"] = {"LinkField":"x_MaritalStatusID","Ajax":true,"AutoFill":false,"DisplayFields":["x_MaritalStatus","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
?>
<form name="ft_usersadd" id="ft_usersadd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="t_users">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_t_usersadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
ft_usersadd.Lists["x_UserLevel"].Options = <?php echo (is_array($t_users->UserLevel->EditValue)) ? ew_ArrayToJson($t_users->UserLevel->EditValue, 1) : "[]" ?>;
</script>
</span>
<?php } ?>
...
ew_CreateCalendar("ft_usersadd", "x_DateOfBirth", "%Y/%m/%d");
</script>
<?php } ?>
</span>
...
ew_CreateCalendar("ft_usersadd", "x_RegisteredOn", "%Y/%m/%d");
</script>
<?php } ?>
</span>
...
ew_CreateCalendar("ft_usersadd", "x_RegistrationValidTill", "%Y/%m/%d");
</script>
<?php } ?>
</span>
