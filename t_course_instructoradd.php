...
$t_course_instructor_add = NULL; // Initialize page object first

class ct_course_instructor_add extends ct_course_instructor {
	...
	// Page object name
	var $PageObjName = 't_course_instructor_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t_course_instructorlist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($t_course_instructor_add)) $t_course_instructor_add = new ct_course_instructor_add();

// Page init
$t_course_instructor_add->Page_Init();

// Page main
$t_course_instructor_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_course_instructor_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var t_course_instructor_add = new ew_Page("t_course_instructor_add");
t_course_instructor_add.PageID = "add"; // Page ID
var EW_PAGE_ID = t_course_instructor_add.PageID; // For backward compatibility

// Form object
var ft_course_instructoradd = new ew_Form("ft_course_instructoradd");

// Validate form
ft_course_instructoradd.Validate = function() {
...
ft_course_instructoradd.Form_CustomValidate = 
...
ft_course_instructoradd.ValidateRequired = true;
<?php } else { ?>
ft_course_instructoradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_course_instructoradd.Lists["x_CourseID"] = {"LinkField":"x_CourseID","Ajax":null,"AutoFill":false,"DisplayFields":["x_CourseCode","x_Course","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_course_instructoradd.Lists["x_SemisterID"] = {"LinkField":"x_SemisterID","Ajax":null,"AutoFill":false,"DisplayFields":["x_Semister","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_course_instructoradd.Lists["x_InstructorID"] = {"LinkField":"x__UserID","Ajax":null,"AutoFill":false,"DisplayFields":["x_LastName","x_FirstName","x_NICNumber",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $t_course_instructor_add->ShowPageHeader(); ?>
<?php
$t_course_instructor_add->ShowMessage();
?>
<form name="ft_course_instructoradd" id="ft_course_instructoradd" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="t_course_instructor">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_t_course_instructoradd" class="table table-bordered table-striped">
...
<?php } ?>
<script type="text/javascript">
ft_course_instructoradd.Lists["x_CourseID"].Options = <?php echo (is_array($t_course_instructor->CourseID->EditValue)) ? ew_ArrayToJson($t_course_instructor->CourseID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
ft_course_instructoradd.Lists["x_SemisterID"].Options = <?php echo (is_array($t_course_instructor->SemisterID->EditValue)) ? ew_ArrayToJson($t_course_instructor->SemisterID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<?php } ?>
<script type="text/javascript">
ft_course_instructoradd.Lists["x_InstructorID"].Options = <?php echo (is_array($t_course_instructor->InstructorID->EditValue)) ? ew_ArrayToJson($t_course_instructor->InstructorID->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
ft_course_instructoradd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$t_course_instructor_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_course_instructor_add->Page_Terminate();
?>
