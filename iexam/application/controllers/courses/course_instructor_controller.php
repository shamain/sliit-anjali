...
class Courses_instructor_controller extends CI_Controller {
    ...
    function __construct() {
        ...
        if (!$this->session->userdata('USER_LOGGED_IN')) {
            ...
            $this->load->model('course_instructor/courses_model');
            $this->load->model('course_instructor//courses_service');
