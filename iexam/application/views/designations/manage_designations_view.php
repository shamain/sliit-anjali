                    ...
                    <tbody>
                        ...
                        foreach ($designations as $designation) {
                            ...
                            <tr id="designation_<?php echo $designation->DesignationID; ?>">
                                ...
                                <td>
                                    <a style="cursor: pointer" onclick="LoadAjaxContent('<?php echo site_url(); ?>/designations/designations_controller/edit_designation_view/<?php echo $designation->DesignationID; ?>')"  title="Edit this Designation">
