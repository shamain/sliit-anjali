...
$t_examinations_edit = NULL; // Initialize page object first

class ct_examinations_edit extends ct_examinations {
	...
	// Page object name
	var $PageObjName = 't_examinations_edit';
	...
	function LoadFormValues() {
		...
		if (!$this->ExaminationID->FldIsDetailKey)
...
// Create page object
if (!isset($t_examinations_edit)) $t_examinations_edit = new ct_examinations_edit();

// Page init
$t_examinations_edit->Page_Init();

// Page main
$t_examinations_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_examinations_edit->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var t_examinations_edit = new ew_Page("t_examinations_edit");
t_examinations_edit.PageID = "edit"; // Page ID
var EW_PAGE_ID = t_examinations_edit.PageID; // For backward compatibility

// Form object
var ft_examinationsedit = new ew_Form("ft_examinationsedit");

// Validate form
ft_examinationsedit.Validate = function() {
...
ft_examinationsedit.Form_CustomValidate = 
...
ft_examinationsedit.ValidateRequired = true;
<?php } else { ?>
ft_examinationsedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_examinationsedit.Lists["x_ExaminationTypeID"] = {"LinkField":"x_ExaminationTypeID","Ajax":true,"AutoFill":false,"DisplayFields":["x_ExaminationType","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_examinationsedit.Lists["x_SeminsterID"] = {"LinkField":"x_SemisterID","Ajax":true,"AutoFill":false,"DisplayFields":["x_Semister","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_examinationsedit.Lists["x_CourseID"] = {"LinkField":"x_CourseID","Ajax":true,"AutoFill":false,"DisplayFields":["x_CourseCode","x_Course","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
ft_examinationsedit.Lists["x_InsttructorID"] = {"LinkField":"x__UserID","Ajax":true,"AutoFill":false,"DisplayFields":["x_LastName","x_FirstName","x_NICNumber",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $t_examinations_edit->ShowPageHeader(); ?>
<?php
$t_examinations_edit->ShowMessage();
?>
<form name="ewPagerForm" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($t_examinations_edit->Pager)) $t_examinations_edit->Pager = new cPrevNextPager($t_examinations_edit->StartRec, $t_examinations_edit->DisplayRecs, $t_examinations_edit->TotalRecs) ?>
<?php if ($t_examinations_edit->Pager->RecordCount > 0) { ?>
<table class="ewStdTable"><tbody><tr><td>
	<?php echo $Language->Phrase("Page") ?>&nbsp;
<div class="input-prepend input-append">
<!--first page button-->
	<?php if ($t_examinations_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $t_examinations_edit->PageUrl() ?>start=<?php echo $t_examinations_edit->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_examinations_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $t_examinations_edit->PageUrl() ?>start=<?php echo $t_examinations_edit->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_examinations_edit->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($t_examinations_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $t_examinations_edit->PageUrl() ?>start=<?php echo $t_examinations_edit->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_examinations_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $t_examinations_edit->PageUrl() ?>start=<?php echo $t_examinations_edit->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_examinations_edit->Pager->PageCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<form name="ft_examinationsedit" id="ft_examinationsedit" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="t_examinations">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<table class="ewGrid"><tr><td>
<table id="tbl_t_examinationsedit" class="table table-bordered table-striped">
...
<input type="hidden" data-field="x_ExaminationID" name="x_ExaminationID" id="x_ExaminationID" value="<?php echo ew_HtmlEncode($t_examinations->ExaminationID->CurrentValue) ?>">
<table class="ewPager">
<tr><td>
<?php if (!isset($t_examinations_edit->Pager)) $t_examinations_edit->Pager = new cPrevNextPager($t_examinations_edit->StartRec, $t_examinations_edit->DisplayRecs, $t_examinations_edit->TotalRecs) ?>
<?php if ($t_examinations_edit->Pager->RecordCount > 0) { ?>
...
<script type="text/javascript">
ft_examinationsedit.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$t_examinations_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_examinations_edit->Page_Terminate();
?>
